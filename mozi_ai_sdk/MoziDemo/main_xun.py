...
from envs.env_hxfb import HXFBEnv
from envs.env_xun import RLENV
from gym.spaces import Discrete, Box, Dict
from ray.rllib.agents.ppo import PPOTrainer

# from ray.managers.zmq_manager import g_zmq_manager
from ray.managers.utils import *
from unifyagent import UnifyTrainer

parser = argparse.ArgumentParser()
#parser.add_argument("--avail_ip_port", type=str, default='127.0.0.1:6060')
#parser.add_argument("--avail_ip_port", type=str, default='172.17.0.2:6060')
parser.add_argument("--avail_ip_port", type=str, default='123.57.142.120:6064')
#parser.add_argument("--avail_ip_port", type=str, default='192.168.1.101:6060')
# 新传入对战相关参数，当前未用
...
parser.add_argument("--platform_mode", type=str, default='auto') #versus # auto # debug #ppo #offline#'offline-online
...
def run(checkpoint=None,
    ...
    agent_name = platform_mode
    agent = UnifyTrainer(12, 15, agent_name, env)
    episode = 50
    agent.train(episode)
...
def rollout(agent,
    ...
    while keep_going(episodes, num_episodes):
        ...
        score = None
        if isinstance(versus_info, dict):  #  and versus_info.__contains__('score')
            score = versus_info['agent_0']['score']
