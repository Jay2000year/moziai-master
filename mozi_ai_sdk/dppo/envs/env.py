...
class Environment(BaseEnvironment):
    ...
    def create_battle_zone(side, side_name):
        ...
        side.add_reference_point(
            zone[0], patrolBoundingBox[0]["latitude"], patrolBoundingBox[0]["longitude"]
        )
        side.add_reference_point(
            zone[1], patrolBoundingBox[1]["latitude"], patrolBoundingBox[1]["longitude"]
        )
        side.add_reference_point(
            zone[2], patrolBoundingBox[2]["latitude"], patrolBoundingBox[2]["longitude"]
        )
        side.add_reference_point(
            zone[3], patrolBoundingBox[3]["latitude"], patrolBoundingBox[3]["longitude"]
        )
