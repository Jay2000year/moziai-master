...
class Environment:
    ...
    def create_defensive_patrol_zone(side, side_name):
        ...
        side.add_reference_point(
            side_name, "rp2", rp12mid["latitude"], rp12mid["longitude"]
        )
        side.add_reference_point(
            side_name, "rp3", rp13mid["latitude"], rp13mid["longitude"]
        )
        side.add_reference_point(
            side_name, "rp4", rp14mid["latitude"], rp14mid["longitude"]
        )
        side.add_reference_point(
            side_name, "rp5", rp23mid["latitude"], rp23mid["longitude"]
        )
        side.add_reference_point(
            side_name, "rp6", rp34mid["latitude"], rp34mid["longitude"]
        )
