...
class Features(object):
    def __init__(self, env, scenario, sideName):
        ...
        self.weapons_type = {
            "toll": "0001",
            "air2air_missile": "0010",
            "antiship_missile": "0100",
        ...
        self.second_category = {
            "idle_unit_type": self.top_category["unit_type"] + "001",
        ...
        self.third_category = {
            "saw_zone": self.second_category["busy_unit_type"] + "00001",
        ...
        self.stat_type = {
            ...
            "self_idle_asuw": self.second_category["idle_unit_type"]
            + self.combact_units_type["asuw"],
            "self_idle_asup": self.second_category["idle_unit_type"]
            + self.combact_units_type["asup"],
            "self_idle_destroyer": self.second_category["idle_unit_type"]
            + self.combact_units_type["destroyer"],
            "self_idle_aircarrier": self.second_category["idle_unit_type"]
            + self.combact_units_type["aircarrier"],
            # 损失的单元类型stat_self_loss_unit_type
            "self_loss_asuw": self.second_category["loss_unit_type"]
            + self.combact_units_type["asuw"],
            "self_loss_asup": self.second_category["loss_unit_type"]
            + self.combact_units_type["asup"],
            "self_loss_destroyer": self.second_category["loss_unit_type"]
            + self.combact_units_type["destroyer"],
            "self_loss_aircarrier": self.second_category["loss_unit_type"]
            + self.combact_units_type["aircarrier"],
            # 任务中的单元类型stat_self_busy_unit_type
            "self_busy_asuw": self.second_category["busy_unit_type"]
            + self.combact_units_type["asuw"],
            "self_busy_asup": self.second_category["busy_unit_type"]
            + self.combact_units_type["asup"],
            "self_busy_destroyer": self.second_category["busy_unit_type"]
            + self.combact_units_type["destroyer"],
            "self_busy_aircarrier": self.second_category["busy_unit_type"]
            + self.combact_units_type["aircarrier"],
            # 在区域saw_zone中的单元类型stat_self_saw_zone_unit_type
            "self_saw_zone_asuw": self.third_category["saw_zone"]
            + self.combact_units_type["asuw"],
            "self_saw_zone_asup": self.third_category["saw_zone"]
            + self.combact_units_type["asup"],
            "self_saw_zone_destroyer": self.third_category["saw_zone"]
            + self.combact_units_type["destroyer"],
            "self_saw_zone_aircarrier": self.third_category["saw_zone"]
            + self.combact_units_type["aircarrier"],
            # 在区域zone_1中的单元类型stat_self_zone_1_unit_type
            "self_zone_1_asuw": self.third_category["zone_1"]
            + self.combact_units_type["asuw"],
            "self_zone_1_asup": self.third_category["zone_1"]
            + self.combact_units_type["asup"],
            "self_zone_1_destroyer": self.third_category["zone_1"]
            + self.combact_units_type["destroyer"],
            "self_zone_1_aircarrier": self.third_category["zone_1"]
            + self.combact_units_type["aircarrier"],
            # 在区域zone_2中的单元类型stat_self_zone_2_unit_type
            "self_zone_2_asuw": self.third_category["zone_2"]
            + self.combact_units_type["asuw"],
            "self_zone_2_asup": self.third_category["zone_2"]
            + self.combact_units_type["asup"],
            "self_zone_2_destroyer": self.third_category["zone_2"]
            + self.combact_units_type["destroyer"],
            "self_zone_2_aircarrier": self.third_category["zone_2"]
            + self.combact_units_type["aircarrier"],
            # 在区域zone_3中的单元类型stat_self_zone_3_unit_type
            "self_zone_3_asuw": self.third_category["zone_3"]
            + self.combact_units_type["asuw"],
            "self_zone_3_asup": self.third_category["zone_3"]
            + self.combact_units_type["asup"],
            "self_zone_3_destroyer": self.third_category["zone_3"]
            + self.combact_units_type["destroyer"],
            "self_zone_3_aircarrier": self.third_category["zone_3"]
            + self.combact_units_type["aircarrier"],
            # 在区域zone_4中的单元类型stat_self_zone_4_unit_type
            "self_zone_4_asuw": self.third_category["zone_4"]
            + self.combact_units_type["asuw"],
            "self_zone_4_asup": self.third_category["zone_4"]
            + self.combact_units_type["asup"],
            "self_zone_4_destroyer": self.third_category["zone_4"]
            + self.combact_units_type["destroyer"],
            "self_zone_4_aircarrier": self.third_category["zone_4"]
            + self.combact_units_type["aircarrier"],
            # 消耗的武器类型stat_self_consumed_weapon_type
            "self_consumed_toll": self.second_category["consumed_weapon_type"]
            + self.weapons_type["toll"],
            "self_consumed_air2airmissile": self.second_category["consumed_weapon_type"]
            + self.weapons_type["air2air_missile"],
            "self_consumed_antishipmissile": self.second_category[
                "consumed_weapon_type"
            ]
            + self.weapons_type["antiship_missile"],
            "self_consumed_airdefensemissile": self.second_category[
                "consumed_weapon_type"
            ]
            + self.weapons_type["airdefense_missile"],
            # 任务中所有单元剩余武器类型stat_self_surplus_weapon_type
            "self_surplus_toll": self.second_category["surplus_weapon_type"]
            + self.weapons_type["toll"],
            "self_surplus_air2airmissile": self.second_category["surplus_weapon_type"]
            + self.weapons_type["air2air_missile"],
            "self_surplus_antishipmissile": self.second_category["surplus_weapon_type"]
            + self.weapons_type["antiship_missile"],
            "self_surplus_airdefensemissile": self.second_category[
                "surplus_weapon_type"
            ]
            + self.weapons_type["airdefense_missile"],
            # 探测到的敌方单元类型stat_hostile_unit_type
            # 'hostile_unknown': self.top_category['contact_type']+self.contacts_type['unknown'],
            "hostile_missile": self.top_category["contact_type"]
            + self.contacts_type["missile"],
            "hostile_aircraft": self.top_category["contact_type"]
            + self.contacts_type["aircraft"],
            "hostile_ship": self.top_category["contact_type"]
            + self.contacts_type["ship"],
            ...
            "hostile_zone_1_missile": self.second_category["hostile_in_zone_1"]
            + self.contacts_type["missile"],
            "hostile_zone_1_aircraft": self.second_category["hostile_in_zone_1"]
            + self.contacts_type["aircraft"],
            "hostile_zone_1_ship": self.second_category["hostile_in_zone_1"]
            + self.contacts_type["ship"],
            ...
            "hostile_zone_2_missile": self.second_category["hostile_in_zone_2"]
            + self.contacts_type["missile"],
            "hostile_zone_2_aircraft": self.second_category["hostile_in_zone_2"]
            + self.contacts_type["aircraft"],
            "hostile_zone_2_ship": self.second_category["hostile_in_zone_2"]
            + self.contacts_type["ship"],
            ...
            "hostile_zone_3_missile": self.second_category["hostile_in_zone_3"]
            + self.contacts_type["missile"],
            "hostile_zone_3_aircraft": self.second_category["hostile_in_zone_3"]
            + self.contacts_type["aircraft"],
            "hostile_zone_3_ship": self.second_category["hostile_in_zone_3"]
            + self.contacts_type["ship"],
            ...
            "hostile_zone_4_missile": self.second_category["hostile_in_zone_4"]
            + self.contacts_type["missile"],
            "hostile_zone_4_aircraft": self.second_category["hostile_in_zone_4"]
            + self.contacts_type["aircraft"],
            "hostile_zone_4_ship": self.second_category["hostile_in_zone_4"]
            + self.contacts_type["ship"],
        }
        n_dims = (
            reduce(lambda x, y: x + len(list(y)), list(self.stat_type.values()), 0)
            + len(self.stat_type) * 2
        )
    ...
    def _features(self):
        # 空闲的单元类型stat_self_idle_unit_type
        feat_self_idle_unit = self._generate_features(
            "stat_self_idle_unit_type",
            "self_idle_asuw",
            "self_idle_asup",
            "self_idle_destroyer",
            "self_idle_aircarrier",
        )
        # 损失的单元类型stat_self_loss_unit_type
        feat_self_loss_unit = self._generate_features(
            "stat_self_loss_unit_type",
            "self_loss_asuw",
            "self_loss_asup",
            "self_loss_destroyer",
            "self_loss_aircarrier",
        )
        # 任务中的单元类型stat_self_busy_unit_type
        feat_self_busy_unit = self._generate_features(
            "stat_self_busy_unit_type",
            "self_busy_asuw",
            "self_busy_asup",
            "self_busy_destroyer",
            "self_busy_aircarrier",
        )
        # 在区域saw_zone中的单元类型stat_self_saw_zone_unit_type
        feat_self_saw_zone_unit = self._generate_features(
            "stat_self_saw_zone_unit_type",
            "self_saw_zone_asuw",
            "self_saw_zone_asup",
            "self_saw_zone_destroyer",
            "self_saw_zone_aircarrier",
        )
        # 在区域zone_1中的单元类型stat_self_zone_1_unit_type
        feat_self_zone_1_unit = self._generate_features(
            "stat_self_zone_1_unit_type",
            "self_zone_1_asuw",
            "self_zone_1_asup",
            "self_zone_1_destroyer",
            "self_zone_1_aircarrier",
        )
        # 在区域zone_2中的单元类型stat_self_zone_2_unit_type
        feat_self_zone_2_unit = self._generate_features(
            "stat_self_zone_2_unit_type",
            "self_zone_2_asuw",
            "self_zone_2_asup",
            "self_zone_2_destroyer",
            "self_zone_2_aircarrier",
        )
        # 在区域zone_3中的单元类型stat_self_zone_3_unit_type
        feat_self_zone_3_unit = self._generate_features(
            "stat_self_zone_3_unit_type",
            "self_zone_3_asuw",
            "self_zone_3_asup",
            "self_zone_3_destroyer",
            "self_zone_3_aircarrier",
        )
        # 在区域zone_4中的单元类型stat_self_zone_4_unit_type
        feat_self_zone_4_unit = self._generate_features(
            "stat_self_zone_4_unit_type",
            "self_zone_4_asuw",
            "self_zone_4_asup",
            "self_zone_4_destroyer",
            "self_zone_4_aircarrier",
        )
        # 消耗的武器类型stat_self_consumed_weapon_type
        feat_self_consumed_weapon = self._generate_features(
            "stat_self_consumed_weapon_type",
            "self_consumed_toll",
            "self_consumed_air2airmissile",
            "self_consumed_antishipmissile",
            "self_consumed_airdefensemissile",
        )
        # 任务中所有单元剩余武器类型stat_self_surplus_weapon_type
        feat_self_surplus_weapon = self._generate_features(
            "stat_self_surplus_weapon_type",
            "self_surplus_toll",
            "self_surplus_air2airmissile",
            "self_surplus_antishipmissile",
            "self_surplus_airdefensemissile",
        )
        # 探测到的敌方单元类型stat_hostile_unit_type
        feat_hostile_unit = self._generate_features(
            "stat_hostile_unit_type",
            "hostile_unknown",
            "hostile_missile",
            "hostile_aircraft",
            "hostile_ship",
        ...
        # 在区域zone_1中的敌方单元类型stat_hostile_zone_1_unit_type
        feat_hostile_zone_1_unit = self._generate_features(
            "stat_hostile_zone_1_unit_type",
            "hostile_zone_1_unknown",
            "hostile_zone_1_missile",
            "hostile_zone_1_aircraft",
            "hostile_zone_1_ship",
        )
        # 在区域zone_2中的敌方单元类型stat_hostile_zone_2_unit_type
        feat_hostile_zone_2_unit = self._generate_features(
            "stat_hostile_zone_2_unit_type",
            "hostile_zone_2_unknown",
            "hostile_zone_2_missile",
            "hostile_zone_2_aircraft",
            "hostile_zone_2_ship",
        )
        # 在区域zone_3中的敌方单元类型stat_hostile_zone_3_unit_type
        feat_hostile_zone_3_unit = self._generate_features(
            "stat_hostile_zone_3_unit_type",
            "hostile_zone_3_unknown",
            "hostile_zone_3_missile",
            "hostile_zone_3_aircraft",
            "hostile_zone_3_ship",
        )
        # 在区域zone_4中的敌方单元类型stat_hostile_zone_4_unit_type
        feat_hostile_zone_4_unit = self._generate_features(
            "stat_hostile_zone_4_unit_type",
            "hostile_zone_4_unknown",
            "hostile_zone_4_missile",
            "hostile_zone_4_aircraft",
            "hostile_zone_4_ship",
        )
    ...
    def _generate_features(self, feat_type, *args):
        ...
        if feat_type == "stat_self_idle_unit_type":
            ...
            for key in [
                ...
                feat_self_idle_unit = np.concatenate(
                    (feat_self_idle_unit, value), axis=0
                )
            ...
            for key in [
                ...
                log_num = np.log10(scaled_num + 1)
                value.append(log_num)
                feat_self_loss_unit = np.concatenate(
                    (feat_self_loss_unit, value), axis=0
                )
            ...
            for key in [
                ...
                log_num = np.log10(scaled_num + 1)
                value.append(log_num)
                feat_self_busy_unit = np.concatenate(
                    (feat_self_busy_unit, value), axis=0
                )
            ...
            for key in [
                ...
                log_num = np.log10(scaled_num + 1)
                value.append(log_num)
                feat_self_saw_zone_unit = np.concatenate(
                    (feat_self_saw_zone_unit, value), axis=0
                )
            ...
            for key in [
                ...
                log_num = np.log10(scaled_num + 1)
                value.append(log_num)
                feat_self_zone_1_unit = np.concatenate(
                    (feat_self_zone_1_unit, value), axis=0
                )
            ...
            for key in [
                ...
                log_num = np.log10(scaled_num + 1)
                value.append(log_num)
                feat_self_zone_2_unit = np.concatenate(
                    (feat_self_zone_2_unit, value), axis=0
                )
            ...
            for key in [
                ...
                log_num = np.log10(scaled_num + 1)
                value.append(log_num)
                feat_self_zone_3_unit = np.concatenate(
                    (feat_self_zone_3_unit, value), axis=0
                )
            ...
            for key in [
                ...
                log_num = np.log10(scaled_num + 1)
                value.append(log_num)
                feat_self_zone_4_unit = np.concatenate(
                    (feat_self_zone_4_unit, value), axis=0
                )
            ...
            for key in [
                ...
                log_num = np.log10(scaled_num + 1)
                value.append(log_num)
                feat_self_consumed_weapon = np.concatenate(
                    (feat_self_consumed_weapon, value), axis=0
                )
            ...
            for key in [
                ...
                log_num = np.log10(scaled_num + 1)
                value.append(log_num)
                feat_self_surplus_weapon = np.concatenate(
                    (feat_self_surplus_weapon, value), axis=0
                )
            ...
            for key in [
                ...
                log_num = np.log10(scaled_num + 1)
                value.append(log_num)
                feat_hostile_zone_1_unit = np.concatenate(
                    (feat_hostile_zone_1_unit, value), axis=0
                )
            ...
            for key in [
                ...
                log_num = np.log10(scaled_num + 1)
                value.append(log_num)
                feat_hostile_zone_2_unit = np.concatenate(
                    (feat_hostile_zone_2_unit, value), axis=0
                )
            ...
            for key in [
                ...
                log_num = np.log10(scaled_num + 1)
                value.append(log_num)
                feat_hostile_zone_3_unit = np.concatenate(
                    (feat_hostile_zone_3_unit, value), axis=0
                )
            ...
            for key in [
                ...
                log_num = np.log10(scaled_num + 1)
                value.append(log_num)
                feat_hostile_zone_4_unit = np.concatenate(
                    (feat_hostile_zone_4_unit, value), axis=0
                )
        ...
        if unit_type == "asuw":
            ...
            for k, v in self.aircrafts.items():
                if int(re.sub("\D", "", v.strLoadoutDBGUID)) == 3004:
                    if len(
                        v.m_MultipleMissionGUIDs
                    ) == 0 or v.strAirOpsConditionString not in [0, 19, 20, 21]:
                        num += 1
            return num
        elif unit_type == "asup":
            num = 0
    ...
    def _get_self_busy_units(self, unit_type):
        ...
        if unit_type == "asuw":
            num = 0
            for k, v in self.aircrafts.items():
                if v.strLoadoutDBGUID == "":
                    continue
                if int(re.sub("\D", "", v.strLoadoutDBGUID)) == 3004:
                    if len(
                        v.m_MultipleMissionGUIDs
                    ) > 0 and v.strAirOpsConditionString in [0, 19, 20, 21]:
                        num += 1
            return num
        elif unit_type == "asup":
            num = 0
            for k, v in self.aircrafts.items():
                ...
                if int(re.sub("\D", "", v.strLoadoutDBGUID)) == 19361:
                    if len(
                        v.m_MultipleMissionGUIDs
                    ) > 0 or v.strAirOpsConditionString in [0, 19, 20, 21]:
                        num += 1
            return num
        elif unit_type == "destroyer":  # 驱逐舰
            num = 0
    ...
    def _get_zone_self_units(self, zone_type, unit_type):
        ...
        zone_ref = [
            {"latitude": v.dLatitude, "longitude": v.dLongitude}
    ...
    def _get_self_consumed_weapon(self, weapon_type):
        ...
        """
        expenditures = list(
            map(lambda x: x.split("$"), self.side.m_Expenditures.split("@"))
        )
    ...
    def _get_self_total_busy_units(self):
        ...
        total_busy_units = []
        for k, v in self.aircrafts.items():
            if len(v.m_MultipleMissionGUIDs) > 0 and v.strAirOpsConditionString in [
                0,
                19,
                20,
                21,
