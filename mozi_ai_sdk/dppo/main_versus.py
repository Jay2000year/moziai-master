...
flags.DEFINE_enum("agent", "ppo", ["ppo", "dqn", "random", "keyboard"], "Agent name.")
...
# flags.DEFINE_string("model_path", current_path + "\\checkpoints\\checkpoint", "Filepath to load initial bcmodel.")
flags.DEFINE_string(
    "model_path",
    current_path + "\\bin\\checkpoints\\checkpoint-5000",
    "Filepath to load initial bcmodel.",
)
