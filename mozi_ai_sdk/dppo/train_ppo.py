...
flags.DEFINE_string("port_A", "5700", "Port for transporting bcmodel.")
...
flags.DEFINE_string("init_model_path", None, "Initial bcmodel path.")
    ...
    class Tempenv(object):
        def __init__(self):
            ...
            self.observation_space = spaces.Tuple(
                [
                    spaces.Box(0.0, float("inf"), [740], dtype=np.float32),
