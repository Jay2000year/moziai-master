...
parser.add_argument(
    "--mozi_server_path", type=str, default="D:\\ZT-mozi\\Mozi\\MoziServer\\bin"
)
...
def run(
    ...
    obs_space = Dict(
        {
            "obs": Box(float("-inf"), float("inf"), shape=(obs_size,)),
...
def rollout(agent, env_name, num_episodes=0, platform_mode=None):
