...
def multi_layer_cnn(rnn_type, matrix, batch):
    ...
    cnn_layer_1 = conv(input_1, 6, 16, 2, "cnn_1")
    cnn_layer_2 = conv(cnn_layer_1, 2, 32, 3, "cnn_2")
    cnn_layer_3 = conv(cnn_layer_2, 8, 256, 4, "cnn_3", padding="VALID")
    ...
    with tf.Session() as session:
        if os.path.exists("new64_8_4_9_tmp_10/checkpoint"):
            saver.restore(session, "new64_8_4_9_tmp_10/pcgrad_regression.ckpt")
