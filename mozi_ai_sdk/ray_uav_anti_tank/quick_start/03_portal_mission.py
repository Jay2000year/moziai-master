...
while not env.is_done():
    ...
    if env.step_count == 0 and not flag:
        ...
        # 根据机场经纬度添加参考点
        point_1 = red_side.add_reference_point(
            "参考点1", airport.dLatitude - 0.8, airport.dLongitude + 0.4
        )
        point_2 = red_side.add_reference_point(
            "参考点2", airport.dLatitude - 0.8, airport.dLongitude + 0.8
        )
        point_3 = red_side.add_reference_point(
            "参考点3", airport.dLatitude - 0.4, airport.dLongitude + 0.8
        )
        point_4 = red_side.add_reference_point(
            "参考点4", airport.dLatitude - 0.4, airport.dLongitude + 0.4
        )
        ...
        # 修改参考点经纬度
        red_side.set_reference_point(
            "参考点1", airport.dLatitude - 0.7, airport.dLongitude + 0.3
        )

        # 设置警戒区
        point_5 = red_side.add_reference_point(
            "参考点5", airport.dLatitude - 1.0, airport.dLongitude + 0.2
        )
        point_6 = red_side.add_reference_point(
            "参考点6", airport.dLatitude - 1.0, airport.dLongitude + 1.0
        )
        point_7 = red_side.add_reference_point(
            "参考点7", airport.dLatitude - 0.2, airport.dLongitude + 1.0
        )
        point_8 = red_side.add_reference_point(
            "参考点8", airport.dLatitude - 0.2, airport.dLongitude + 0.2
        )
        # 根据参考点创建巡逻任务
