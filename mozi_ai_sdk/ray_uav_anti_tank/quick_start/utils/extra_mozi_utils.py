...
# 根据距离和方位生成参考点
for i in range(6):
    point_lat_lon = geo.get_point_with_point_bearing_distance(
        airport.dLatitude, airport.dLongitude, 60 * i, 100
    )
    red_side.add_reference_point(
        f"新参考点-{i}", point_lat_lon["latitude"], point_lat_lon["longitude"]
    )
...
print(
    geo.get_two_point_distance(
        airport.dLongitude, airport.dLatitude, rp_1.dLongitude, rp_1.dLatitude
    )
)
pass
...
print(
    geo.get_degree(
        airport.dLatitude, airport.dLongitude, rp_1.dLatitude, rp_1.dLongitude
    )
)
print(
    geo.get_degree(
        rp_1.dLatitude, rp_1.dLongitude, airport.dLatitude, airport.dLongitude
    )
)
pass
...
geo.plot_square(
    4, red_side, (rp_5.dLatitude, rp_5.dLongitude), (rp_2.dLatitude, rp_2.dLongitude)
)
pass
...
lat, lon = geo.get_cell_middle(
    4,
    (rp_5.dLatitude, rp_5.dLongitude),
    (rp_2.dLatitude, rp_2.dLongitude),
