...
from mozi_ai_sdk.sc_code.envs.env_sc_new import (
    SCEnv,
...
def run(
    checkpoint=None, evaluate_episodes=10, avail_ip_port=None, platform_mode="eval"
):
...
def rollout(
    ...
    # }
    action_init = {p: flatten_to_single_ndarray(0) for p, m in policy_map.items()}
