...
class AutoregressiveActionModel(TFModelV2):
    ...
    def __init__(self, obs_space, action_space, num_outputs, model_config, name):
        ...
        if action_space != Tuple([Discrete(2), Discrete(2)]):
            raise ValueError("This bcmodel only supports the [2, 2] action space")
        ...
        # Output of the bcmodel (normally 'logits', but for an autoregressive
...
class TorchAutoregressiveActionModel(TorchModelV2, nn.Module):
    ...
    def __init__(self, obs_space, action_space, num_outputs, model_config, name):
        ...
        if action_space != Tuple([Discrete(3), Discrete(2)]):
            raise ValueError("This bcmodel only supports the [3, 2] action space")
