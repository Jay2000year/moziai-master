...
class TestSide(TestFramework):
    ...
    def test_add_unit(self):
        """添加单元"""
        self.red_side.add_unit(
            "ship", "B", 383, 61.4871723614997, -17.2522930173048, 30
        )
        self.env.step()
        ships = self.red_side.get_ships()
        flag = False
    ...
    def test_add_aircraft(self):
        """添加飞机"""
        self.red_side.add_aircraft(
            "飞机-添加", 6, 119, 30.9381715388612, 121.062106870304, 5000, 30
        )
        self.env.step()
    ...
    def test_add_unit_to_facility(self):
        ...
        return_obj_2 = self.red_side.add_unit_to_facility(
            unit_type="ship", name="基地舰船-新", dbid=4, base_unit_guid=self.wharf_1_guid
        )
        return_obj_3 = self.red_side.add_unit_to_facility(
            unit_type="sub", name="基地潜艇-新", dbid=5, base_unit_guid=self.wharf_1_guid
        )
        self.env.step()
    ...
    def test_add_reference_point(self):
        """添加参考点"""
        point = self.red_side.add_reference_point(
            "点1", 27.6642320262197, 134.621472742701
        )
        self.env.step()
    ...
    def test_set_zone(self):
        ...
        self.red_side.set_zone(
            zone_guid=zone_2.strGuid,
            description="封锁区-该",
            area=area,
            affects=affects,
            is_active="false",
    ...
    def test_assign_target_to_mission(self):
        ...
        self.red_side.assign_target_to_mission(
            self.enemy_airplane_guid, strike_mission.strGuid
        )
        self.red_side.assign_target_to_mission(
            self.enemy_airplane_guid_2, strike_mission.strName
        )
        self.env.step()
        self.env.step()
    ...
    def test_set_side_options(self):
        ...
        self.red_side.set_side_options(
            awareness=awareness,
    ...
    def test_delete_reference_point_by_name(self):
        """按参考点名称删除参考点"""
        point = self.red_side.add_reference_point(
            "RP-XX", 27.6642320262197, 134.621472742701
        )
        self.env.step()
        self.env.step()
